...
const { createQuestion, getSpecificQuestion,
    deleteSpecificQuestion, updateQuestion, getQuestionsByQuizId } = require('../controller/question_controller');
...
router.get('/:quiz_id/questions', authMiddleware, getQuestionsByQuizId);
